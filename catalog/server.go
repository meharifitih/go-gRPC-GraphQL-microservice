...
import (
	...
	pb "github.com/meharifitih/go-grpc-graphql-microservice/catalog/pb"
...
func ListenGRPC(s Service, port int) error {
	...
	pb.RegisterCatalogServiceServer(serve, &grpcServer{service: s})
...
func (s *grpcServer) GetProducts(ctx context.Context, r *pb.GetProductsRequest) (*pb.GetProductsResponse, error) {
	...
	if r.Query != "" {
		...
		s.service.GetProducts(ctx, r.Skip, r.Take)
	}
